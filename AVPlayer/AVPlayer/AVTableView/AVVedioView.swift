...
class AVVedioView: UIView {
    
    override init(frame: CGRect) {
        super.init(frame: frame)
        self.initializationAVVedioView()
    }
    ...
    lazy var backView: UIView = {
        let tempView = UIView()
        tempView.frame = CGRect.init(x: 0, y: 0, width: k_ScreenWidth-30.0, height: (k_ScreenWidth-30)/2)
    ...
    func initializationAVVedioView (){
...
//        }
    ...
    func handleScreenPortrait(isBtnClick: Bool) {
        ...
        UIView.animate(withDuration: 0.5, animations: {
            ...
            weakSelf?.backView.frame = CGRect.init(x: 0, y: 0, width: UIScreen.main.bounds.width - 30, height: (UIScreen.main.bounds.width - 30)/2)
